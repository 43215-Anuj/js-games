function CEndPanel(){
    ...
    this._init = function(){
        ...
        _oLevelClearedText = new CTLText(
            _oContainerPanel,
            iX - iWidth / 2,
            iY - iHeight / 2,
            iWidth,
        ...
        iHeight = 60;
        iY = oSpriteBg.height / 2;
        _oLevelScoreText = new CTLText(
            _oContainerPanel,
            iX - iWidth / 2,
            iY - iHeight / 2,
            iWidth,
        ...
        iY = oSpriteBg.height / 2 + 100;
        _oTotScoreText = new CTLText(
            _oContainerPanel,
            iX - iWidth / 2,
            iY - iHeight / 2,
            iWidth,
        ...
        _oButHome = new CGfxButton(
            oSpriteBg.width / 2 - 250,
            oSpriteBg.height / 2 + 270,
    ...
    this.show = function(iTotScore, iLevelScore){
        ...
        createjs.Tween.get(_oContainerPanel)
            .wait(400)
            .to({ y: CANVAS_HEIGHT / 2 }, 1000, createjs.Ease.bounceOut);
    };
